...
| `trip-lifecycle` | Composes Plan, Implement, Review, and Release as verified rounds under one OPE-keyed Ringer artifact. | Open Engine owns an implementation issue and needs approval gates, strict review verdicts, and release evidence without another orchestrator. | Proven in a recorded run, 2026-07-14 |
