...
| `trip-lifecycle` | Composes Plan, Implement, Review, and Release as verified rounds under one OPE-keyed Ringer artifact. | Open Engine owns an implementation issue and needs approval gates, strict review verdicts, and release evidence without another orchestrator. | Blueprint |
